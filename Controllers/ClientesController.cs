...
namespace ADweb.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(ADDBContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Direccion,Correo,Telefono,Localidad")] Clientes clientes)
        {
            if (id != clientes.Id)
            {
                return NotFound();
        ...
        public IActionResult Filtro(String selector)
        {
            ...
            var tipo = (from s in _context.Clientes where s.Localidad.Equals(selector) select s).ToList();
        ...
        {
            return (from n in _context.ConfiguracionLocalidades select n.Localidades).ToList();
        }
    }
}
