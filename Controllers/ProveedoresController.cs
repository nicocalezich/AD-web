...
namespace ADweb.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(ADDBContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,TipoMercaderia,Direccion,Telefono,NombrePersonal")] Proveedores proveedores)
        {
